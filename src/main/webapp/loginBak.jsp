        ...
        <div id="tabcon">
            <div class="box show">
                <form action="user" method="post" id="loginForm">
                    <input type="hidden" name="actionName" value="login"/><!--用hidden表示用户行为，通过这个参数判断Servlet中用户访问的操作-->
                    ...
                    <input name="rem" type="checkbox" value="1"  class="inputcheckbox"/> <label>记住用户</label>&nbsp; &nbsp;
...
<div id="bottom">
    <div id="copyright">
        <div class="quick">
            <ul>
                <li><input type="button" class="quickbd iphone" onclick="location.href='https://www.touhou-project.com/'" /></li>
                <li><input type="button" class="quickbd android" onclick="location.href='https://www.touhou-project.com/'" /></li>
                <li><input type="button" class="quickbd pc" onclick="location.href='https://www.touhou-project.com/'" /></li>
                <div class="clr"></div>
            </ul>
            <div class="clr"></div>
        </div>
        <div class="text">
            Copyright © 2006-2026  <a href="https://www.touhou-project.com/">上海红茶馆</a>  All Rights Reserved
        </div>
    </div>
</div>
</body>
